...
<details>
  ...
  Звяртаю тваю ўвагу, што прыметнік "важны" не мае дачынення да "добры", "дрэнны" і да "лепшы", "горшы". Напрыклад, можа здарыцца як добрая так и дрэнная, але ўсё адно важная падзея.
